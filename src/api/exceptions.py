...
class AuthorizationError(BaseAPIException):
    ...
    def __init__(self, message: str = "Access denied", details: Optional[Dict[str, Any]] = None, request_id: Optional[str] = None):
        super().__init__(
            message=message,
...
class ServiceUnavailableError(BaseAPIException):
    ...
    def __init__(self, message: str = "Service temporarily unavailable", details: Optional[Dict[str, Any]] = None, request_id: Optional[str] = None):
        super().__init__(
            message=message,
...
class TimeoutError(BaseAPIException):
    ...
    def __init__(self, message: str = "Request timeout", timeout_seconds: Optional[float] = None, request_id: Optional[str] = None):
