    ...
    def on_epoch_end(
        ...
        if should_save:
            ...
            self._save_checkpoint(
                checkpoint_path, epoch, model, optimizer, metrics, scheduler, scaler
            )
        ...
        if self.save_last:
            ...
            self._save_checkpoint(last_path, epoch, model, optimizer, metrics, scheduler, scaler)

        # Save best model separately
        if is_best:
            best_path = self.checkpoint_dir / "best_model.pt"
            self._save_checkpoint(best_path, epoch, model, optimizer, metrics, scheduler, scaler)
