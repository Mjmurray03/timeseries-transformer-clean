...
from src.backtesting.backtest_report import BacktestReport, BacktestResults, create_sample_backtest_results
...
from scripts.backtesting.run_backtest import (
    load_predictions, load_market_data, create_backtest_config,
    create_backtest_results_from_engine, CustomBacktestEngine,
    BacktestConfig
)
...
def test_ml_threshold_strategy():
    ...
    try:
        ...
        predictions = pd.Series({
            ...
            'MSFT': {'return_5d': 0.015, 'confidence': 0.6, 'volatility': 0.018},  # Below confidence threshold
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            mock_results = {
                ...
                'trades_log': [
                    {'ticker': 'AAPL', 'type': 'BUY', 'shares': 100, 'price': 150.0, 'timestamp': '2023-01-15'},
                    {'ticker': 'AAPL', 'type': 'SELL', 'shares': 100, 'price': 158.0, 'timestamp': '2023-01-20'}
                ],
                'portfolio_history': []
            }
...
def test_realistic_transaction_costs():
    ...
    try:
        ...
        percentage_commission = trade_value * market_params['cost_model']['commission']['percentage']
