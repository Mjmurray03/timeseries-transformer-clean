...
from ..strategy import TradingSignal, Strategy
...
class MLThresholdStrategy(Strategy):
    ...
    def __init__(
        ...
        **kwargs
        ...
        logger.info(f"MLThresholdStrategy initialized: "
            ...
            if isinstance(predictions, pd.Series):
                ...
                for ticker, pred_value in predictions.items():
                    ...
                    if isinstance(pred_value, dict):
                        ml_pred = MLPrediction(
                            ...
                            predicted_return_3d=pred_value.get('predicted_return_3d', pred_value.get('return_3d', 0.0)),
                ...
                for idx, row in predictions.iterrows():
                    ...
                    ml_pred = MLPrediction(
                        ...
                        predicted_return_3d=row.get('predicted_return_3d', row.get('return_3d', 0.0)),
            ...
            for ticker, position in positions.items():
                ...
                if abs(weight_diff) > self.rebalance_threshold:
                    ...
                    if weight_diff > 0:
                        ...
                        # Decrease position
                        shares_to_sell = int(abs(weight_diff) * total_value / position.current_price)
