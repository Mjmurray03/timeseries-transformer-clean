...
class TrainingConfig:
    ...
    def from_dict(cls, config_dict: Dict[str, Any]) -> "TrainingConfig":
        ...
        # Create main config
        return cls(optimizer=optimizer, scheduler=scheduler, loss=loss, **config_dict)
    ...
    def from_args(cls, args: Union[argparse.Namespace, Dict[str, Any]]) -> "TrainingConfig":
        ...
        param_mapping = {
            ...
            "epochs": (
                ...
                "num_epochs",
                int,
                lambda x: cls._validate_positive_int(x, "num_epochs"),
            ),
            "num_epochs": (
                "config",
                "num_epochs",
            ...
            "batch_size": (
                ...
                "batch_size",
                int,
                lambda x: cls._validate_positive_int(x, "batch_size"),
            ),
            "batch-size": (
                "config",
                "batch_size",
            ...
            "gradient_accumulation_steps": (
                ...
                "gradient_accumulation_steps",
                int,
                lambda x: cls._validate_positive_int(x, "gradient_accumulation_steps"),
            ),
            ...
            "gradient_clip": (
                ...
                "gradient_clip",
                float,
                lambda x: cls._validate_positive_float(x, "gradient_clip"),
            ),
            "gradient-clip": (
                "config",
                "gradient_clip",
            ...
            "num_workers": (
                ...
                "num_workers",
                int,
                lambda x: cls._validate_non_negative_int(x, "num_workers"),
            ),
            "num-workers": (
                "config",
                "num_workers",
            ...
            "save_every": (
                ...
                "save_every",
                int,
                lambda x: cls._validate_positive_int(x, "save_every"),
            ),
            "save-every": (
                "config",
                "save_every",
            ...
            "early_stopping_patience": (
                ...
                "early_stopping_patience",
                int,
                lambda x: cls._validate_positive_int(x, "early_stopping_patience"),
            ),
            ...
            "early_stopping_min_delta": (
                ...
                "early_stopping_min_delta",
                float,
                lambda x: cls._validate_non_negative_float(x, "early_stopping_min_delta"),
            ),
            ...
            "log_every": (
                ...
                "log_every",
                int,
                lambda x: cls._validate_positive_int(x, "log_every"),
            ),
            "log-every": (
                "config",
                "log_every",
            ...
            "val_every": (
                ...
                "val_every",
                int,
                lambda x: cls._validate_positive_int(x, "val_every"),
            ),
            "val-every": (
                "config",
                "val_every",
            ...
            "train_split": (
                ...
                "train_split",
                float,
                lambda x: cls._validate_split(x, "train_split"),
            ),
            "train-split": (
                "config",
                "train_split",
            ...
            "val_split": (
                ...
                "val_split",
                float,
                lambda x: cls._validate_split(x, "val_split"),
            ),
            "val-split": (
                "config",
                "val_split",
            ...
            "test_split": (
                ...
                "test_split",
                float,
                lambda x: cls._validate_split(x, "test_split"),
            ),
            "test-split": (
                "config",
                "test_split",
            ...
            "warmup-steps": (
                ...
                "warmup_steps",
                int,
                lambda x: cls._validate_non_negative_int(x, "warmup_steps"),
            ),
            "warmup_steps": (
                "config",
                "warmup_steps",
            ...
            "input-dim": (
                ...
                "input_dim",
                int,
                lambda x: cls._validate_positive_int(x, "input_dim"),
            ),
            "input_dim": (
                "model",
                "input_dim",
            ...
            "hidden-dim": (
                ...
                "hidden_dim",
                int,
                lambda x: cls._validate_positive_int(x, "hidden_dim"),
            ),
            "hidden_dim": (
                "model",
                "hidden_dim",
            ...
            "num-heads": (
                ...
                "num_heads",
                int,
                lambda x: cls._validate_positive_int(x, "num_heads"),
            ),
            "num_heads": (
                "model",
                "num_heads",
            ...
            "num-layers": (
                ...
                "num_layers",
                int,
                lambda x: cls._validate_positive_int(x, "num_layers"),
            ),
            "num_layers": (
                "model",
                "num_layers",
            ...
            "dropout": (
                ...
                "dropout",
                float,
                lambda x: cls._validate_non_negative_float(x, "dropout"),
            ),
            "max-seq-length": (
                "model",
                "max_seq_length",
                int,
                lambda x: cls._validate_positive_int(x, "max_seq_length"),
            ),
            "max_seq_length": (
                "model",
                "max_seq_length",
            ...
            "output-dim": (
                ...
                "output_dim",
                int,
                lambda x: cls._validate_positive_int(x, "output_dim"),
            ),
            "output_dim": (
                "model",
                "output_dim",
            ...
            "forecast-horizon": (
                ...
                "forecast_horizon",
                int,
                lambda x: cls._validate_positive_int(x, "forecast_horizon"),
            ),
            "forecast_horizon": (
                "model",
                "forecast_horizon",
            ...
            "learning_rate": (
                ...
                "learning_rate",
                float,
                lambda x: cls._validate_positive_float(x, "learning_rate"),
            ),
            "learning-rate": (
                "optimizer",
                "learning_rate",
            ...
            "weight_decay": (
                ...
                "weight_decay",
                float,
                lambda x: cls._validate_non_negative_float(x, "weight_decay"),
            ),
            "weight-decay": (
                "optimizer",
                "weight_decay",
            ...
            "max_steps": (
                ...
                "max_steps",
                int,
                lambda x: cls._validate_positive_int(x, "max_steps"),
            ),
            "max-steps": (
                "scheduler",
                "max_steps",
            ...
            "min_lr": (
                ...
                "min_lr",
                float,
                lambda x: cls._validate_non_negative_float(x, "min_lr"),
            ),
            "min-lr": (
                "scheduler",
                "min_lr",
            ...
            "patience": (
                ...
                "patience",
                int,
                lambda x: cls._validate_positive_int(x, "patience"),
            ),
            "factor": (
                "scheduler",
                "factor",
                float,
                lambda x: cls._validate_positive_float(x, "factor"),
            ),
        }
        ...
        for arg_name, arg_value in args_dict.items():
            ...
            if arg_name in param_mapping:
                ...
                try:
                    ...
                    raise ValueError(
                        f"Invalid value for parameter '{arg_name}': {arg_value}. Error: {e}"
                    )
...
def create_production_config() -> TrainingConfig:
    ...
    return TrainingConfig(
        ...
        optimizer=OptimizerConfig(learning_rate=5e-5, weight_decay=0.01),
        scheduler=SchedulerConfig(name="cosine", warmup_steps=2000, max_steps=50000),
