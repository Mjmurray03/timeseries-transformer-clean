...
from .schemas import PredictionRequest, PredictionResponse, PredictionMetadata, ConfidenceInterval
...
class ModelServer:
    ...
    def postprocess_output(self, output: torch.Tensor, ticker: str, 
    ...
    def _generate_confidence_intervals(self, predictions: list, horizon: int) -> Dict[str, ConfidenceInterval]:
