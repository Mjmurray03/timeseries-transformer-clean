...
class LearnedPositionalEncoding(nn.Module):
    ...
    def __init__(self, max_seq_len: int = 60, d_model: int = 256, dropout: float = 0.1):
        super().__init__()
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        ), f"Model dimension {d_model} doesn't match expected {self.d_model}"
...
class SinusoidalPositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int = 256, max_seq_len: int = 10000, dropout: float = 0.1):
        super().__init__()
...
class RelativePositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int = 256, max_relative_position: int = 32, dropout: float = 0.1):
        super().__init__()
...
class AdaptivePositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int = 256, max_seq_len: int = 60, dropout: float = 0.1):
        super().__init__()
        ...
        self.sinusoidal_encoding = SinusoidalPositionalEncoding(
            d_model, max_seq_len * 2, dropout=0.0
        )
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        combined_encoding = (
            gate_weights[:, :, 0:1] * learned_encoded + gate_weights[:, :, 1:2] * sinusoidal_encoded
        )
...
class TemporalPositionalEncoding(nn.Module):
    ...
    def __init__(
        ...
        self.temporal_embedding = nn.Parameter(torch.randn(1, max_seq_len, d_model) * 0.02)
