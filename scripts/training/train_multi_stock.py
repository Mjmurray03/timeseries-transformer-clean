...
class MultiStockDataProcessor:
    ...
    def load_and_process_ticker(self, ticker: str, seq_len: int = 60, 
    ...
    def create_sequences(self, data: np.ndarray, seq_len: int, 
...
def main():
    ...
    if args.tickers:
        ...
        if not tickers:
            raise ValueError(f"None of the specified tickers {args.tickers} are available. "
